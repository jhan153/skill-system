...
`automations/` are also excluded from 7.2.1 core because this bundle is not an automatic runtime loop.
...
## Removed From 7.2.1 Core

7.2.1 core excludes automatic install flow, promotion flow, release flow, signoff workflow, rollback flow, evidence intake flow, evidence closure flow, package-cut scoring, runtime config replacement, automations, default `.system` payload, and skill-system finality modeling.
