...
The current architecture line is `8.x — Context Compounding / Wiki Bank Architecture`. The current maintenance cut is `8.5.0 — WorkItem Lifecycle Governance`, following the `8.4.4 — Activation Surface & Feedback Hardening` release.
