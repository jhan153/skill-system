...
The current architecture line is `8.x — Context Compounding / Wiki Bank Architecture`. The current maintenance cut is `8.5.1 — Work Horizon Routing Clarification`, following the `8.5.0 — WorkItem Lifecycle Governance` release.
