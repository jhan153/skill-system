...
The current architecture line is `8.x — Context Compounding / Wiki Bank Architecture`. The current maintenance cut is `8.4.0 — Fable Harness Reinforcement`, following the `8.3.2 — Verification Scope Cleanup` release.
