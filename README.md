...
The current architecture line is `8.x — Context Compounding / Wiki Bank Architecture`. The current maintenance cut is `8.4.4 — Activation Surface & Feedback Hardening`, following the `8.4.3 — Live Manifest Finalization Hardening` release.
