...
The current architecture line is `8.x — Context Compounding / Wiki Bank Architecture`. The current maintenance cut is `8.4.2 — Runtime Capability Closure`, following the `8.4.1 — Checkpointed Execution & Harness Parity` release.
