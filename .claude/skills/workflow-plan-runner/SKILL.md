...
- context_targets:
  ...
  read_if_needed:
    ...
    - `.claude/docs/delivery_slice_contract.md` when the approved scope needs multiple executable batches, including a wide migration or non-feature decomposition
