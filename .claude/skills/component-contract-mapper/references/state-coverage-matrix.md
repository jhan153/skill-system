...
- Missing focus, keyboard, target-size, or accessible-name states should hand off to `accessibility-audit-harness`.
- Missing visual state proof should hand off to `visual-regression-harness`.
- Missing token/state styling should hand off to `design-token-pipeline`.
