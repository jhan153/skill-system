...
| `analysis-llm-wiki-context` | `analysis` | `support` | `skill-system-core` | `true` |
| `analysis-performance` | `analysis` | `primary` | `skill-system-dev` | `true` |
| `design-a11y-audit` | `design` | `design_evidence_gate` | `skill-system-design` | `true` |
| `design-component-mapper` | `design` | `design_evidence_gate` | `skill-system-design` | `true` |
...
| `design-tokens` | `design` | `design_evidence_gate` | `skill-system-design` | `true` |
| `design-ui-decomposer` | `design` | `primary_analysis` | `skill-system-design` | `true` |
| `design-visual-regression` | `design` | `design_evidence_gate` | `skill-system-design` | `true` |
| `management-knowledge-base-init` | `management` | `knowledge_operation` | `skill-system-core` | `true` |
| `management-knowledge-base-maintenance` | `management` | `knowledge_operation` | `skill-system-core` | `true` |
| `management-knowledge-base-read` | `management` | `support` | `skill-system-core` | `true` |
| `management-knowledge-base-record` | `management` | `knowledge_operation` | `skill-system-core` | `true` |
| `management-knowledge-base-update` | `management` | `knowledge_operation` | `skill-system-core` | `true` |
| `management-memory-bank-harness` | `management` | `support` | `skill-system-core` | `true` |
| `management-memory-bank-init` | `management` | `memory_operation` | `skill-system-core` | `true` |
| `management-memory-bank-maintenance` | `management` | `memory_operation` | `skill-system-core` | `true` |
| `management-memory-bank-update` | `management` | `memory_operation` | `skill-system-core` | `true` |
| `management-project-context` | `management` | `project_context_operation` | `skill-system-core` | `true` |
| `management-project-context-checkpoint` | `management` | `project_context_operation` | `skill-system-core` | `true` |
| `plan-behavior-discovery` | `planning` | `primary` | `skill-system-dev` | `true` |
| `plan-decision-map` | `planning` | `primary` | `skill-system-core` | `true` |
| `plan-execution-handoff` | `planning` | `primary` | `skill-system-core` | `true` |
| `plan-question-document` | `planning` | `primary` | `skill-system-core` | `true` |
| `plan-requirements-brief` | `planning` | `primary` | `skill-system-core` | `true` |
| `plan-requirements-discovery` | `planning` | `primary` | `skill-system-core` | `true` |
| `plan-task-handoff` | `planning` | `support` | `skill-system-core` | `true` |
| `plan-test-discovery` | `testing` | `support` | `skill-system-testing` | `true` |
| `report-critical` | `report` | `report_primary` | `skill-system-core` | `true` |
| `report-implementation-explainer` | `report` | `report_primary` | `skill-system-core` | `true` |
| `report-lifecycle-artifacts` | `report` | `report_primary` | `skill-system-core` | `true` |
| `report-qualitative` | `report` | `report_primary` | `skill-system-core` | `true` |
| `research-experiment-blueprint` | `research` | `primary` | `skill-system-research` | `true` |
| `research-experiment-scaffold` | `research` | `heavy_artifact_generator` | `skill-system-research` | `true` |
...
| `research-manuscript-writing` | `research` | `primary` | `skill-system-research` | `true` |
...
| `test-evidence-review` | `testing` | `testing_evidence_gate` | `skill-system-testing` | `true` |
...
| `test-visual-regression` | `testing` | `testing_design_or_evidence_specialist` | `skill-system-testing` | `true` |
...
| `workflow-research` | `research` | `execution_primary` | `skill-system-research` | `true` |
