...
현재 아키텍처 라인은 `8.x — Context Compounding / Wiki Bank Architecture`입니다. 현재 maintenance cut은 `8.4.2 — Runtime Capability Closure`이며 `8.4.1 — Checkpointed Execution & Harness Parity` 다음 릴리스입니다.
