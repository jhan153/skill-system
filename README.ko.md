...
현재 아키텍처 라인은 `8.x — Context Compounding / Wiki Bank Architecture`입니다. 현재 maintenance cut은 `8.5.1 — Work Horizon Routing Clarification`이며 `8.5.0 — WorkItem Lifecycle Governance` 다음 릴리스입니다.
