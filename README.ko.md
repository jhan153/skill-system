...
현재 아키텍처 라인은 `8.x — Context Compounding / Wiki Bank Architecture`입니다. 현재 구현 패키지는 `8.0.2 — Context Compounding Field Hardening`입니다. hook/runtime validation, analysis-codebase hardening, home-install path 정리를 반영한 context-compounding field package입니다.
