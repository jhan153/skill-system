...
이 소스 트리는 breaking 10.0 기준선의 10.3.0 컨텍스트 선택·근거 기반 실행 릴리즈입니다.
공통 멀티에이전트 방어를 유지하면서 선택한 그래프의 상세만 읽고, 독립 버그 수정은 새 근거에 따라
계속하며, 소스 읽기를 제외된 검증 작업과 구분합니다. 현재 구성은 다음과 같습니다.
