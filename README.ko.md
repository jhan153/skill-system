...
이 소스 트리는 breaking 10.0 기준선의 10.3.1 스킬 계약·참조 정합성 보완 릴리즈입니다.
스킬과 공통 참조의 소유권·근거 경계를 맞추고, 선택적 Canvas 출력에서 상세 보고서의 모든 발견
사항을 보존하며, 생성된 라우팅 리소스의 경로를 이식 가능하게 만듭니다. 구현·DAG 예시의 동시성,
데이터 보존, 복구 조건도 명확히 했습니다. 현재 구성은 다음과 같습니다.
