...
## 8.x 방향: Context Compounding

현재 아키텍처 라인은 `8.x — Context Compounding / Wiki Bank Architecture`입니다. 현재 maintenance cut은 `8.4.4 — Activation Surface & Feedback Hardening`이며 `8.4.3 — Live Manifest Finalization Hardening` 다음 릴리스입니다.
