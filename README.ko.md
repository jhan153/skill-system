...
현재 아키텍처 라인은 `8.x — Context Compounding / Wiki Bank Architecture`입니다. 현재 maintenance cut은 `8.5.0 — WorkItem Lifecycle Governance`이며 `8.4.4 — Activation Surface & Feedback Hardening` 다음 릴리스입니다.
