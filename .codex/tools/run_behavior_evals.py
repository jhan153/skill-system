#!/usr/bin/env python3
"""Replay-first behavior eval runner for 7.3.1 execution assurance."""
...
def main() -> int:
    ...
    parser.add_argument("--bundle-version", default="7.3.1")
    parser.add_argument("--format", choices=["text", "json"], default="text")
    args = parser.parse_args()
    if args.mode != "replay":
        print(f"SKIP: mode {args.mode!r} is not implemented in 7.3.1 replay pilot")
        return 0
