...
EXPECTED: dict[str, dict[str, str]] = {
    ...
    "plan-decision-map": {"work_horizon": "long_plan", "planning_altitude": "strategic_package"},
    "plan-stakeholder-questionnaire": {"work_horizon": "one_shot", "planning_altitude": "requirements_discovery"},
