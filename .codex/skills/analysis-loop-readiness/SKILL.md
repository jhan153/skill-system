...
| `loop_worthy` | stable material conditions are authorable and repeated verifier results can change the next implementation action | `plan-loop-term` for contract and verifier map; runner only after acceptance |
