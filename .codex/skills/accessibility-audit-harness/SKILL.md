---
name: accessibility-audit-harness
...
6. Hand off unresolved gaps:
   - Missing visual proof goes to `visual-regression-harness`.
   - Missing state coverage goes to `component-contract-mapper`.
   - Missing token values go to `design-token-pipeline`.
