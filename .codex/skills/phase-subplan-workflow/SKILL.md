...
- If the user only needs a lightweight active plan, return to scheduling and use `plan-doc-workflow`.
...
- Use `plan-doc-workflow` instead when a lightweight active plan is enough.
