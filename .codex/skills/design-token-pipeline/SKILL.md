...
- do_not_use_when:
  ...
  - the user asks for direct UI implementation from a concrete visual artifact; use `design-to-frontend` as primary and this skill only as a supporting gate.
- expected_inputs:
...
6. Hand off evidence:
   - Provide token mapping to `design-to-frontend`, `component-contract-mapper`, or visual review when implementation continues.
...
- This skill cannot certify full accessibility contrast alone; hand off contrast to `accessibility-audit-harness`.
