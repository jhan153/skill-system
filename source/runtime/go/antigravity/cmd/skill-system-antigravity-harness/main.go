...
import (
	...
	"skill-system.local/harness/antigravity/internal/projectcontext"
)
...
func contextCLI(args []string) {
	if len(args) == 0 || args[0] != "resolve" {
		fmt.Fprintln(os.Stderr, "usage: skill-system-antigravity-harness context resolve [--start PATH] [--manifest PATH]")
		return
	}
